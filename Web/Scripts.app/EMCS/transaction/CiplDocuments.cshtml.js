...
function load_data_tabledoc() {
  var columnDocument = [
    ...
    },
    {
      ...
      formatter: function (data, row) {
        if (row.Filename !== "") {
          var btnDownload =
            "<button class='btn btn-xs btn-link btn-success download' type='button'><i class='tim-icons icon-cloud-download-93'></i></button>";
          var btnPreview =
            "<button class='btn btn-xs btn-link btn-info btn-outline showDocument' type='button' data-toggle='modal' data-target='#myModalUploadPreview'><i class='tim-icons icon-single-copy-04'></i></button>";
  ...
  function operateFormatter() {
    ...
    btn.push(
      '<button type="button" class="btn btn-info btn-link btn-xs edit" data-toggle="modal" data-target="#myModalDocument" title="Edit"><i class="tim-icons icon-pencil"></i></button>\
    ...
    btn.push(
      '<button type="button" class="btn btn-danger btn-link btn-xs remove" title="Delete"><i class="tim-icons icon-simple-remove"></i></button>'
    );
    btn.push("</div>");
    return btn.join("");
  }
